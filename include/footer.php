...
<footer class="page-footer">
    ...
    <div class="footer-copyright blue lighten white-text">
        <div class="container" id="footer">
            <?php
                $query = mysqli_query($config, "SELECT * FROM tbl_instansi");
                while($data = mysqli_fetch_array($query)){
            ?>
                <span class="white-text"><center>&copy; <?php echo date("Y"); ?> <?php echo $data['nama'] .' &nbsp; | &nbsp; DEVELOP BY NOURA YUMNA</center></span>
                ';?>
            <?php } ?>
        </div>
    </div>
