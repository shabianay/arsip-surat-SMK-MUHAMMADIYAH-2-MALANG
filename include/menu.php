...
<nav class="blue  lighten -">
    <div class="nav-wrapper">
        <a href="./asset/img/lg.jpg/" class="brand-logo center hide-on-large-only">E-Arsip SMK MUDA</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
            <li class="no-padding">
                <div class="logo-side center blue  lighten -6">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                ...
                                echo '<img class="logoside" src="./asset/img/lg.jpg"/>';
                            }
                            if(!empty($data['nama'])){
                                echo '<h5 class="smk-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="smk-side">SMK MUDA </h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">JJl. Baiduri Sepah No.27, Tlogomas, Kec. Lowokwaru, Kota Malang, Jawa Timur 65144</p>';
                            }
                        }
                    ?>
                </div>
            </li>
            <li class="no-padding blue  lighten -6">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li>&nbsp;&nbsp;<i href="./" class="material-icons"><img src="./upload/lg.jpg
            " width="45px" height="45px" /></i><a href="./" class="ams hide-on-med-and-down"> SMK MUDA  </a></li>
            <li><div class="grs"></></li>
