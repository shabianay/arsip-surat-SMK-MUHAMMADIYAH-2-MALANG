...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2023 at 03:30 PM
...
(7, '.', 'ccc', 'Informasikan', '2023-02-03', 'cc', 23, 1),
(8, 'Wk Kurikulum', '-', 'Tindak Lanjut', '2023-02-04', '-', 25, 1);
...
INSERT INTO `tbl_instansi` (`id_instansi`, `institusi`, `nama`, `status`, `alamat`, `kepsek`, `NBM`, `website`, `email`, `logo`, `id_user`) VALUES
(1, 'Pendidikan Dasar dan Menengah Pimpinan Daerah Muhammadiyah Kota Malang', 'SMK MUHAMMADIYAH 2 MALANG', 'STATUS \"TERAKREDITASI\"', 'Jl. Baiduri Sepah No.27, Telepon (0341)552857, Faximile (0341)552857 Kota Malang 65114', 'LUKMAN HAKIM, S.HI, M.Pd.I', '1.003.998', 'https://www.smkm2malang.sch.id', 'smkm2_mlg@yahoo.co.id', 'lg.jpg', 1);
...
(19, 3, 'Permohonan Izin Orang Tua', '02.3549/SMKM.2/05/2023', 'Izin Melakukan Magang', 'm', '2023-02-05', '2023-02-03', '7027-Contoh-surat-perjanjian-kerjasama-dalam-bidang-bisnis-FH-UII.doc', '-', 1);
...
(1, 12, 'dd', 'dd', 'ddd', 'C5', '33', '2023-02-03', '2023-02-03', '8058-CV_Noura Yumna_190412630165_LLL (1).pdf', 'ff', 1),
(2, 3212, '2.12.147/UN32.4.1/DL/2022', 'Universitas Negeri Malang', 'Penelitian Skripsi\r\n', 'Kurikulum', 'C', '2022-12-02', '2023-02-04', '3542-Surat observasi kampus.pdf', '-', 1);
...
(1, 'Admin', '21232f297a57a5a743894a0e4a801fc3', 'Tata Usaha', '-', 1),
(2, 'staff', '82849c85acf1f4e6e4eec748f0aeddf4', 'Staff', '-', 3);
