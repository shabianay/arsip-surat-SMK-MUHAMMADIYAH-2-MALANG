...
if (empty($_SESSION['admin'])) {
    ...
    <?php
            if (isset($_REQUEST['submit'])) {
                ...
                echo '
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="10%">No. Berkas<br/>Nomor Pakket</th>
                ...
                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE isi LIKE '%$cari%' OR no_agenda LIKE '%$cari%' ORDER by id_surat DESC LIMIT 15");
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="24%">No Petunjuk <br/>Alamat Pengirim</th>
                                        <th width="18%">No. Surat<br/>Tgl Surat</th>
