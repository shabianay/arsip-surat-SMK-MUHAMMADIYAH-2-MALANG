                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td id="right" width="18%"><strong>Nomor Petunjuk</strong></td>
                                <td id="left" style="border-right: none;" width="57%">: '.$row['indeks'].'</td>
                                <td id="left" width="25"><strong>Nomor Pakket</strong> : '.$row['kode'].'</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td id="left"><strong>No. Berkas</strong> : '.$row['no_agenda'].'</td>
                            </tr>
                            <tr>
                            ...
                            <tr class="isi">
                                ...
                                <td><strong>Kepada Yth. <br/> 1. Wk. Kurikulum <br/> 2. Wk. Kesiswaan <br/> 3. Wk. Humas <br/> 4. Wk. Sarpras <br/> 5. Wk. Ismuba <br/> 6. Ka. TU <br/> 7. Keuangan <br/> 8. MR IT <br/> 9. Ketua Program
                                ...
                                <tr class="isi">
                                    ...
                                    <td><strong>Diteruskan Kepada Wk. Kurikulum</strong> : </td>
                                </tr>';
                            }
                        } echo '
                </tbody>
