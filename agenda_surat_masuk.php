                ...
                echo '
                    ...
                    <div id="colres" class="warna cetak">
                        <table class="bordered" id="tbl" width="100%">
                            ...
                            <tr>
                            <th width="3%">No Berkas</th>
                            <th width="5%">Nomor Pakket</th>
                            <th width="5%">Nomor Petunjuk</th>
                            <th width="21%">Perihal</th>
                            <th width="18%">Alamat Pengirim</th>
                            <th width="15%">Nomor Surat</th>
                            <th width="20%">Tanggal<br/> Surat</th>
                    ...
                    if(mysqli_num_rows($query) > 0){
                        ...
                        while($row = mysqli_fetch_array($query)){
                         ...
                         <tr>
                                ...
                                <td>';
                                        if(!empty($row['file'])){
                                            echo ' <td><a href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">'.$row['file'].'</a></td>';
                                        } else {
